...
public final class MimeTypeConstants {  
   ...
   static 
   {
      ...
      s_mapMimeTypes.put("dot", "application/msword");
      s_mapMimeTypes.put("docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document");
      s_mapMimeTypes.put("dotx", "application/vnd.openxmlformats-officedocument.wordprocessingml.template");
      s_mapMimeTypes.put("docm", "application/vnd.ms-word.document.macroEnabled.12");
      s_mapMimeTypes.put("dotm", "application/vnd.ms-word.template.macroEnabled.12");
      ...
      s_mapMimeTypes.put("mdb", "application/vnd.ms-access");
      ...
      s_mapMimeTypes.put("pot", "application/vnd.ms-powerpoint");
      s_mapMimeTypes.put("pps", "application/vnd.ms-powerpoint");
      s_mapMimeTypes.put("ppa", "application/vnd.ms-powerpoint");
      ...
      s_mapMimeTypes.put("ppam", "application/vnd.ms-powerpoint.addin.macroEnabled.12");
      s_mapMimeTypes.put("pptm", "application/vnd.ms-powerpoint.presentation.macroEnabled.12");
      s_mapMimeTypes.put("potm", "application/vnd.ms-powerpoint.template.macroEnabled.12");
      s_mapMimeTypes.put("ppsm", "application/vnd.ms-powerpoint.slideshow.macroEnabled.12");
      ...
      s_mapMimeTypes.put("xlt", "application/vnd.ms-excel");
      s_mapMimeTypes.put("xla", "application/vnd.ms-excel");
      s_mapMimeTypes.put("xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
      s_mapMimeTypes.put("xltx", "application/vnd.openxmlformats-officedocument.spreadsheetml.template");
      s_mapMimeTypes.put("xlsm", "application/vnd.ms-excel.sheet.macroEnabled.12");
      s_mapMimeTypes.put("xltm", "application/vnd.ms-excel.template.macroEnabled.12");
      s_mapMimeTypes.put("xlam", "application/vnd.ms-excel.addin.macroEnabled.12");
      s_mapMimeTypes.put("xlsb", "application/vnd.ms-excel.sheet.binary.macroEnabled.12");
   ...
   public static String getMimeType(String filename){
      ...
      strMimeType = (String)s_mapMimeTypes.get(ext);
